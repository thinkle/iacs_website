...
data = [
    ...
    ('front.html','0B-fhMzqaF6ywb1dKalJaTkthUWM',ms_feeds + hs_feeds + [
        ...
        ], {'shown_initially':3,'total_limit':8}),
    ('main_sports.html','0B-fhMzqaF6ywWWwxQ05xb0tTa1k',hs_sports_feeds + ms_sports_feeds,{'shown_initially':3,'total_limit':8}),
    ('ms_sports.html',  '0B-fhMzqaF6ywZlJIQ2RmTXd1ZEE',ms_sports_feeds,{'shown_initially':3,'total_limit':8}),
